    ...
    return (
        ...
        >
            <HStack className="tag" spacing={5}>
                <Link href={href}>
                    <a>
                        <Text as='span' color={tagColor} fontSize='md' fontWeight='semibold'>
                            SELF-HELP
                        </Text>
                    </a>
                </Link>
            ...
            <Link href={href}>
                <a>
                    <Heading my={{ base: '1', lg: '2', xl: '3' }} color={textColor} fontSize='2xl'>How to remember more of what you read</Heading>
                </a>
            </Link>

            <Text color={textColor} fontSize='md' my={{ base: '1', lg: '2', xl: '3' }} noOfLines={3} lineHeight={{ base: '1.7', lg: '1.9', xl: '1.9' }}>
            ...
            <Flex justify='space-between'>
                <Text color={textColor} opacity='70%' fontSize='md'>5 April, 2021</Text>
                <Link href={href}>
                    <a>
                        <Flex align='center'>
                            <Text color={tagColor} mr={3} fontSize='md' fontWeight='semibold'>
                                Read more {' '}
                            </Text>
